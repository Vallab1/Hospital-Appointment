  ...
  return docInfo && (
    <div>
      ...
      <div className='flex sm:flex-row gap-4'>
        ...
        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          ...
          <div>
            ...
            <p className='text-sm text-justify text-gray-500 max-w-[700px] mt-1'>{docInfo.about}</p>
      ...
      <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
        ...
        <button className='bg-primary text-white text-lg font-light px-14 py-3 rounded-full my-6'>Book an appointment</button>
      </div>
