...
const MyProfile = () => {
  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          <p>Address</p>
          {
            isEdit ?
              <p>
                <input className='bg-gray-50' type="text" onChange={(e) => setUserData(prev => ({ ...prev, address: { ...prev.address, street: e.target.value } }))} value={userData.address.street} />
                <br />
                <input className='bg-gray-50' type="text" onChange={(e) => setUserData(prev => ({ ...prev, address: { ...prev.address, city: e.target.value } }))} value={userData.address.city} />
              </p>
      ...
      <div className='w-10 mt-10 grid grid-cols-[1fr_1fr] gap-4 '>
